...
class ThemeFiles extends AbstractTheme
{
    ...
    {
        $cssDir = $this->getBaseDir() . 'themes' . DIRECTORY_SEPARATOR . 'default' . DIRECTORY_SEPARATOR;
    ...
    {
        $path = $this->componentRegistrar->getPath(ComponentRegistrar::MODULE, 'Mpaz_ProgressBar');
